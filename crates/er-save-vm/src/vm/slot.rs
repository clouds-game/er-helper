pub mod slot_view_model {
    use er_save::save_slot::SaveSlot;
    use crate::{vm::{equipment::equipment_view_model::EquipmentViewModel, events::events_view_model::EventsViewModel, general::general_view_model::GeneralViewModel, inventory::InventoryViewModel, regions::regions_view_model::RegionsViewModel, stats::stats_view_model::StatsViewModel}};
